...
import "./cljs-runtime/acme.frontend.app.js";
SHADOW_ENV.setLoaded("acme.frontend.app.js");
import "./cljs-runtime/shadow.module.main.append.js";
SHADOW_ENV.setLoaded("shadow.module.main.append.js");
export let hello = acme.frontend.app.hello;

try { acme.frontend.app.init(); } catch (e) { console.error("An error occurred when calling (acme.frontend.app/init)"); throw(e); }
